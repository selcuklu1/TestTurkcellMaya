...
public class AntetIslemleri extends BaseTest {
    ...
    public static final User ztekin = new User("ztekin", "123", "Zübeyde TEKİN", "GENEL MÜDÜRLÜK MAKAMI");
...
//                .paraflaKontrol();
        ...
        evrakOlusturPage
                ...
                .editorAntetKontrol("T.C. \n ANKARA", "Normal Antet", "Üst Birim Normal Antet");
