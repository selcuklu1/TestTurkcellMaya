...
//        WebDriverRunner.setWebDriver((new EventFiringWebDriver(WebDriverRunner.getWebDriver()).register(new DriverEventListener())));
    ...
    private void iliskiliEvraklar() {
        ...
        altTabs.getDosyaEkleTab().shouldBe(visible);
        altTabs.sistemdeKayitliEvrakEkleTabiAc()
                .evrakTarihiBasGir("01.01.2017")
                .evrakAraDoldur("01-310.01.01-9563")
                .dokumanAraTikla()
                .islemMesaji().basariliOlmali();
    ...
    private void editorTabGalen() throws IOException {
        ...
        */
        ...
        birim                   xpath   //div[@id='yeniOnayEvrakForm:allPanels_content']//span[.='${birim}']/..
        */
        /*params.put("editorAntetBaslik", "T.C.\nANKARA");
        params.put("kurumHeaderSatir1", user1.getBirimAdi());
        params.put("kurumHeaderSatir2", user1.getBirimAdi());
        params.put("kurumHeaderSatir3", user1.getBirimAdi());*/
