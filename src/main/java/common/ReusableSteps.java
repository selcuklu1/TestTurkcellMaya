...
public class ReusableSteps extends BaseLibrary{
    ...
    @Step("Beklemeye Alınanlar evrak Oluştur.")
    public void beklemeyeAlinanlarEvrakOlustur(String konu,String konuKodu,String kaldirilicakKlasor,String icerik,String geregiSecimTipi, String geregi, String onayAkisiKullanici1Turu,String onayAkisiKullanici2,String onayAkisiKullaniciBirimi,String onayAkisiKullanici2turu,String user,String password) {

        EvrakOlusturPage evrakOlusturPage = new EvrakOlusturPage();
        LoginPage loginPage = new LoginPage();
        ImzaBekleyenlerPage imzaBekleyenler = new ImzaBekleyenlerPage();

        evrakOlusturPage.evrakOlusturParafla(konu,konuKodu,kaldirilicakKlasor,icerik,geregiSecimTipi,geregi,onayAkisiKullanici1Turu,onayAkisiKullanici2,onayAkisiKullaniciBirimi,onayAkisiKullanici2turu);
        loginPage.login(user,password);
        imzaBekleyenler.imzaBekleyenlerEvrakSecBeklemeyeAl(konu);
    }
